  ...
  const [messages, setMessages] = useState<ChatMessage[]>([
    {
      id: 'welcome',
      role: 'model',
      text: "Hello! I'm your Virtual Science Tutor powered by Team SUPRA. I can help you with Physics, Chemistry, Biology, Math, or CS labs. What are you working on today?",
      timestamp: Date.now(),
    },
  ]);
    ...
    try {
      ...
      setMessages((prev) => [
        ...prev,
        {
          id: Date.now().toString(),
          role: 'model',
          text: "I'm having trouble connecting to the neural network right now. Please check your API key configuration.",
          timestamp: Date.now(),
        },
      ]);
    } finally {
      ...
      <div className="flex-1 glass-panel rounded-3xl overflow-hidden flex flex-col shadow-2xl border border-purple-500/20">
        ...
        <div className="bg-purple-900/20 p-6 border-b border-white/10 flex items-center gap-4 backdrop-blur-xl">
          ...
          <div>
            ...
            <p className="text-xs text-purple-300 font-mono tracking-wide uppercase">Powered by Team SUPRA</p>
          </div>
        </div>
        ...
        <div className="p-4 bg-black/30 border-t border-white/10">
            ...
            <p className="text-center text-[10px] text-gray-600 mt-2">Team SUPRA AI can make mistakes. Check important info.</p>
        </div>
      </div>
    </div>
  );
